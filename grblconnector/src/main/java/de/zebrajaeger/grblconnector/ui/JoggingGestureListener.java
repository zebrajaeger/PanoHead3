...
import de.zebrajaeger.grblconnector.grbl.move.Move;
import de.zebrajaeger.grblconnector.grbl.move.Moveable;

/**
 * Created by Lars Brandt on 16.07.2017.
 */
public class JoggingGestureListener implements GestureDetector.OnGestureListener, Moveable {
    ...
    public JoggingGestureListener() {
        Timer timer = new Timer("Jogging Gesture Timer");
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("JoggingGestureListener", "Timer Failed", e);
                }
            }
        }, 0, TIMER_PERIOD);
    }
